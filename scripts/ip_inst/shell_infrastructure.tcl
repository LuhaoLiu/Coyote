...
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_stlb_ctrl
set_property -dict [list CONFIG.C_DATA_DEPTH {2048} CONFIG.C_NUM_OF_PROBES {45} CONFIG.C_PROBE44_WIDTH {3} CONFIG.C_PROBE43_WIDTH {2} CONFIG.C_PROBE42_WIDTH {2} CONFIG.C_PROBE41_WIDTH {11} CONFIG.C_PROBE40_WIDTH {11} CONFIG.C_PROBE39_WIDTH {11} CONFIG.C_PROBE38_WIDTH {11} CONFIG.C_PROBE37_WIDTH {32} CONFIG.C_PROBE36_WIDTH {32} CONFIG.C_PROBE35_WIDTH {32} CONFIG.C_PROBE34_WIDTH {32} CONFIG.C_PROBE33_WIDTH {10} CONFIG.C_PROBE32_WIDTH {10} CONFIG.C_PROBE31_WIDTH {10} CONFIG.C_PROBE30_WIDTH {10} CONFIG.C_PROBE29_WIDTH {2} CONFIG.C_PROBE26_WIDTH {104} CONFIG.C_PROBE25_WIDTH {48} CONFIG.C_PROBE24_WIDTH {32} CONFIG.C_PROBE23_WIDTH {32} CONFIG.C_PROBE22_WIDTH {32} CONFIG.C_PROBE21_WIDTH {32} CONFIG.C_PROBE20_WIDTH {10} CONFIG.C_PROBE19_WIDTH {10} CONFIG.C_PROBE18_WIDTH {10} CONFIG.C_PROBE17_WIDTH {10} CONFIG.C_PROBE16_WIDTH {16} CONFIG.C_PROBE15_WIDTH {2} CONFIG.C_PROBE13_WIDTH {2} CONFIG.C_PROBE11_WIDTH {128} CONFIG.C_PROBE10_WIDTH {128} CONFIG.C_PROBE7_WIDTH {5} CONFIG.C_PROBE6_WIDTH {5} CONFIG.C_PROBE5_WIDTH {5} CONFIG.C_PROBE4_WIDTH {5} CONFIG.C_PROBE3_WIDTH {36} CONFIG.C_PROBE2_WIDTH {36} CONFIG.C_PROBE1_WIDTH {36} CONFIG.C_PROBE0_WIDTH {36} CONFIG.Component_Name {ila_stlb_ctrl}] [get_ips ila_stlb_ctrl]
